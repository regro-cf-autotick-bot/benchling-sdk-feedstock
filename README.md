...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/benchling-sdk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13216&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/benchling-sdk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `benchling-sdk` can be installed with:

```
conda install benchling-sdk
```

It is possible to list all of the versions of `benchling-sdk` available on your platform with:
